...
rnn = rnn_util.RNNFrame(rnn_cells, dropout=dropout, bidirectional=bidirectional)
...
rnn = rnn_util.RNNFrame(rnn_cells, dropout=dropout, bidirectional=bidirectional, batch_first=True)
